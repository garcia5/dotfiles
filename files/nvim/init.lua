...
vim.opt.diffopt = { -- smarter diff detection
    "internal", -- use builtin diff library
...
vim.opt.complete = "o^25,.,w,b,u,t,f,Fv:lua.require'ag.sources.files'.complete" -- limit # completion items per source
