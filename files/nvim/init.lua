...
vim.wo.wrap          = true                                               -- wrap my text
vim.wo.breakindent   = true                                               -- wrapped lines continue on visual indent
vim.g.showbreak      = string.rep(' ', 3)                                 -- 'smart' wrap
vim.wo.linebreak     = true                                               -- allow long lines to wrap more nicely
