        ...
        config = function()
            require("gitsigns").setup({
                ...
                on_attach = function(bufnr)
                    ...
                    -- vim.api.nvim_set_hl(0, "GitSignsDeleteLnInline", { link = "GitSignsDelete" })
                    -- vim.api.nvim_set_hl(0, "GitSignsDeleteInline", { link = "GitSignsDelete" })
                    -- vim.api.nvim_set_hl(0, "GitSignsAddInline", { link = "GitSignsAddLn" })
                    -- vim.api.nvim_set_hl(0, "GitSignsAddLnInline", { link = "GitSignsAddLn" })
                    -- vim.api.nvim_set_hl(0, "GitSignsChangeInline", { link = "GitSignsChangeLn" })
                    -- vim.api.nvim_set_hl(0, "GitSignsChangeLnInline", { link = "GitSignsChangeLn" })
                end,
            })
        end,
    })
