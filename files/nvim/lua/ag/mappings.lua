...
mapper("n", "<Leader>ds", "<cmd>lua require('dap').step_over()<CR>")
mapper("n", "<Leader>dr", "<cmd>lua require('dap').repl.open()<CR>")
mapper("n", "<Leader>df", "<cmd>lua require('dapui').float_element('scopes')<CR>") -- show local/global variable info in floating window
mapper("n", "<Leader>du", "<cmd>lua require('dapui').toggle()<CR>") -- toggle on/off pretty ui
