...
vim.keymap.set("n", "<Leader>nt", "<cmd>NvimTreeToggle<CR>", { desc = "toggle NvimTree", silent = true })
vim.keymap.set("n", "<Leader>nf", ":NvimTreeFindFile<CR>", { desc = "find current file in NvimTree", silent = true })
